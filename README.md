...
* **[WhatKeyIsThis-MLOps](https://github.com/MLsound/WhatKeyIsThis-MLOps)**
    ...
    * *Highlights:* Integrates Spotify's "basic_pitch" model with a web interface.
* **[darwin-audio](https://github.com/MLsound/darwin-audio)**
    * *Focus:* General audio processing experiments and development.
...
* **[tango-lyrics-corpus](https://github.com/MLsound/tango-lyrics-corpus)**
    * *Focus:* Natural Language Processing applied to cultural heritage (Tango).
* **[weather-time-series](https://github.com/MLsound/weather-time-series)**
    * *Focus:* Predictive modeling and time-series analysis on meteorological data.
 
## Connect

* [LinkedIn](https://www.linkedin.com/in/lloveras/)
* [Kaggle](https://www.kaggle.com/alejandrolloveras)

<!--
**MLsound/MLsound** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
